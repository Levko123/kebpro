...
const copy = {
  hu: {
    ...
    landing: { benefitsTitle: "Kiemelt előnyök", faqTitle: "Gyakori kérdések" },
    footer: { description: "Magyar tulajdonú, családi vállalkozásként gyorsfagyasztott gyros- és kebab termékek gyártásával, illetve országos kiszállítással állunk partnereink rendelkezésére.", legal: "Jogi oldalak", contact: "Kapcsolat", privacy: "Adatkezelési tájékoztató", complaints: "Panaszkezelési szabályzat", imprint: "Impresszum", whistleblowing: "Belső Visszaélés-Bejelentés", seoTitle: "Kiemelt keresések", seoLinks: [{ href: "/gyros-gyartas", label: "Gyros és kebab gyártás" }, { href: "/gyros-nagyker", label: "Gyros nagyker" }, { href: "/eredeti-gyros", label: "Eredeti gyros" }, { href: "/csirke-gyros", label: "Csirke gyros" }, { href: "/horeca-gyros-beszallito", label: "Gyros és kebab kiszállítás" }], copyright: "© Copyright 2026 Halasi Kebpro Kft." },
  ...
  en: {
    ...
    landing: { benefitsTitle: "Key advantages", faqTitle: "Frequently asked questions" },
    footer: { description: "As a Hungarian-owned family company, we supply frozen gyros and kebab products with nationwide refrigerated delivery for our partners.", legal: "Legal", contact: "Contact", privacy: "Privacy notice", complaints: "Complaint handling policy", imprint: "Imprint", whistleblowing: "Internal Whistleblowing", seoTitle: "Key searches", seoLinks: [{ href: "/gyros-gyartas", label: "Gyros and kebab production" }, { href: "/gyros-nagyker", label: "Gyros wholesale" }, { href: "/eredeti-gyros", label: "Original gyros" }, { href: "/csirke-gyros", label: "Chicken gyros" }, { href: "/horeca-gyros-beszallito", label: "Gyros and kebab delivery" }], copyright: "© Copyright 2026 Halasi Kebpro Ltd." },
    ...
    contact: { eyebrow: "Contact", title: "Get in touch with us.", lead: "For general information, partnership topics or logistics questions, our colleagues are ready to help.", details: "Contact details", company: "Company", address: "Address", phone1: "Phone 1", phone2: "Phone 2", fax: "Fax", email: "E-mail", opening: "Office hours", openingHours: "Mon-Fri 08:00-16:00", quickTitle: "Quick access", quickText: "For pricing requests please use the Request Quote page, and for direct ordering use the Order page.", locationTitle: "Location", phoneTitle: "Phone", emailTitle: "E-mail address", emailReveal: "Show e-mail address", emailRevealError: "The e-mail address is currently unavailable.", hoursTitle: "Office hours", mapTitle: "How to find us", quickQuoteText: "Request a personalised quote for our products quickly and easily.", quickOrderText: "Place your order directly through our online platform.", quickCareer: "Career", quickCareerText: "Join our team — check out our open positions." },
  ...
  de: {
    ...
    landing: { benefitsTitle: "Wichtige Vorteile", faqTitle: "Häufige Fragen" },
    footer: { description: "Als ungarisches Familienunternehmen beliefern wir unsere Partner mit tiefgekühlten Gyros- und Kebabprodukten sowie gekühlter landesweiter Zustellung.", legal: "Rechtliches", contact: "Kontakt", privacy: "Datenschutzhinweis", complaints: "Beschwerdeordnung", imprint: "Impressum", whistleblowing: "Internes Hinweisgebersystem", seoTitle: "Wichtige Suchen", seoLinks: [{ href: "/gyros-gyartas", label: "Gyros- und Kebab-Produktion" }, { href: "/gyros-nagyker", label: "Gyros-Großhandel" }, { href: "/eredeti-gyros", label: "Original Gyros" }, { href: "/csirke-gyros", label: "Hähnchen-Gyros" }, { href: "/horeca-gyros-beszallito", label: "Gyros- und Kebab-Lieferung" }], copyright: "© Copyright 2026 Halasi Kebpro GmbH" },
